...
./configure_header_list.py SupportGLFW      kvs/glfw
./configure_header_list.py SupportFFmpeg    kvs/ffmpeg
...
./configure_header_list.py SupportMPI       kvs/mpi
