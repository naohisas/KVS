...
// @file   compress.c
// @brief  RLE image compression routines for 234compositor
...
//#ifndef COMPOSITOR234_COMPRESS_H_INCLUDE
//#include "compress.h"
//#define COMPOSITOR234_COMPRESS_H_INCLUDE
//#endif
...
/*===========================================================================*/
/**
 *  @brief RLE_Compress() - Compress a block of data using an RLE coder.
 *
 *  @param  in     [in]  Input (uncompressed) buffer
 *  @param  insize [in]  Number of input bytes
 *  @param  out    [out] Output (compressed) buffer
 *
 *  @return The function returns the size of the compressed data
 */
/*===========================================================================*/
...
/*===========================================================================*/
/**
 *  @brief RLE_Uncompress() - Uncompress a block of data using an RLE decoder.
 *
 *  @param  in     [in] Input (compressed) buffer
 *  @param  insize [in] Number of input bytes
 *  @param  out    [out] Output (uncompressed) buffer
 *
 *  @return The function returns the size of the deflated data
 */
/*===========================================================================*/
