...
/*===========================================================================*/
/**
 *  @brief  Key code class.
 */
/*===========================================================================*/
class KVSKey
{
#if ( KVS_QT_VERSION >= 4 )
    using Mod = Qt::KeyboardModifiers;
    static const auto ModShift = Qt::ShiftModifier;
    static const auto ModControl = Qt::ControlModifier;
    static const auto ModAlt = Qt::AltModifier;
    #define KVSKey_const_Mod const KVSKey::Mod
#else
    using Mod = Qt::ButtonState;
    static const auto ModShift = Qt::ShiftButton;
    static const auto ModControl = Qt::ControlButton;
    static const auto ModAlt = Qt::AltButton;
    #define KVSKey_const_Mod KVSKey::Mod
#endif

public:
    static int Code( const int key, KVSKey_const_Mod modifier );
    static int Modifier( KVSKey_const_Mod modifier );
};

/*===========================================================================*/
/**
 *  @brief  Returns KVS key code.
 *  @param  key [in] Qt key code
 *  @param  modifier [in] key modifier code
 *  @return KVS key code
 */
/*===========================================================================*/
inline int KVSKey::Code( const int key, KVSKey_const_Mod modifier )
{
    const bool shift = ( modifier == KVSKey::ModShift );
    switch ( key )
    {
...
/*===========================================================================*/
/**
 *  @brief  Returns KVS modifier key code.
 *  @param  modifier [in] Qt modifier key code
 *  @return KVS modifier key code
 */
/*===========================================================================*/
inline int KVSKey::Modifier( KVSKey_const_Mod modifier )
{
    switch ( modifier )
    {
    case KVSKey::ModShift:   return kvs::Key::ShiftModifier;
    case KVSKey::ModControl: return kvs::Key::ControlModifier;
    case KVSKey::ModAlt:     return kvs::Key::AltModifier;
    default: break;
    }
