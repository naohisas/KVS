...
/****************************************************************************/
#ifndef KVS__COLOR_MAP_DATA_H_INCLUDE
#define KVS__COLOR_MAP_DATA_H_INCLUDE

// Reference about colormap data:
// https://github.com/BIDS/colormap/blob/master/colormaps.py

void getMagmaColor(const size_t value0, double color_data0[3], const size_t value1, double color_data1[3])
{
    const double magma_color_data[256][3] =
    {
    ...
    color_data0[0] = magma_color_data[value0][0];
    color_data0[1] = magma_color_data[value0][1];
    color_data0[2] = magma_color_data[value0][2];

    color_data1[0] = magma_color_data[value1][0];
    color_data1[1] = magma_color_data[value1][1];
    color_data1[2] = magma_color_data[value1][2];
}

void getInfernoColor(const size_t value0, double color_data0[3], const size_t value1, double color_data1[3])
{
    const double inferno_color_data[256][3] =
    {
            { 0.001462, 0.000466, 0.013866 },
    ...
    color_data0[0] = inferno_color_data[value0][0];
    color_data0[1] = inferno_color_data[value0][1];
    color_data0[2] = inferno_color_data[value0][2];

    color_data1[0] = inferno_color_data[value1][0];
    color_data1[1] = inferno_color_data[value1][1];
    color_data1[2] = inferno_color_data[value1][2];
}

void getPlasmaColor(const size_t value0, double color_data0[3], const size_t value1, double color_data1[3])
{
    const double plasma_color_data[256][3] =
    {
    ...
    color_data0[0] = plasma_color_data[value0][0];
    color_data0[1] = plasma_color_data[value0][1];
    color_data0[2] = plasma_color_data[value0][2];

    color_data1[0] = plasma_color_data[value1][0];
    color_data1[1] = plasma_color_data[value1][1];
    color_data1[2] = plasma_color_data[value1][2];
}

void getViridisColor(const size_t value0, double color_data0[3], const size_t value1, double color_data1[3])
{
    const double viridis_color_data[256][3] =
    {
    ...
    color_data0[0] = viridis_color_data[value0][0];
    color_data0[1] = viridis_color_data[value0][1];
    color_data0[2] = viridis_color_data[value0][2];

    color_data1[0] = viridis_color_data[value1][0];
    color_data1[1] = viridis_color_data[value1][1];
    color_data1[2] = viridis_color_data[value1][2];
}

void getCividisColor(const size_t value0, double color_data0[3], const size_t value1, double color_data1[3])
{
    const double cividis_color_data[256][3] =
        {
    ...
    color_data0[0] = cividis_color_data[value0][0];
    color_data0[1] = cividis_color_data[value0][1];
    color_data0[2] = cividis_color_data[value0][2];

    color_data1[0] = cividis_color_data[value1][0];
    color_data1[1] = cividis_color_data[value1][1];
    color_data1[2] = cividis_color_data[value1][2];
}

#endif // KVS__COLOR_MAP_DATA_H_INCLUDE