...
// Visual Studio 2022 Update 1
#elif ( _MSC_VER == 1931 )
#define KVS_COMPILER_VERSION_MAJOR 17
#define KVS_COMPILER_VERSION_MINOR 1
#define KVS_COMPILER_VERSION_PATCH 0

// Visual Studio 2022 Update 2
#elif ( _MSC_VER == 1932 )
#define KVS_COMPILER_VERSION_MAJOR 17
#define KVS_COMPILER_VERSION_MINOR 2
#define KVS_COMPILER_VERSION_PATCH 0

// Visual Studio 2022 Update 3
#elif ( _MSC_VER == 1933 )
#define KVS_COMPILER_VERSION_MAJOR 17
#define KVS_COMPILER_VERSION_MINOR 3
#define KVS_COMPILER_VERSION_PATCH 0

// Visual Studio 2022 Update 4
#elif ( _MSC_VER == 1934 )
#define KVS_COMPILER_VERSION_MAJOR 17
#define KVS_COMPILER_VERSION_MINOR 4
#define KVS_COMPILER_VERSION_PATCH 0

// Visual Studio 2022 Update 5
#elif ( _MSC_VER == 1935 )
#define KVS_COMPILER_VERSION_MAJOR 17
#define KVS_COMPILER_VERSION_MINOR 5
#define KVS_COMPILER_VERSION_PATCH 0

// Visual Studio 2022 Update 6
#elif ( _MSC_VER == 1936 )
#define KVS_COMPILER_VERSION_MAJOR 17
#define KVS_COMPILER_VERSION_MINOR 6
#define KVS_COMPILER_VERSION_PATCH 2

// Visual Studio 2022 Update 7
#elif ( _MSC_VER == 1937 )
#define KVS_COMPILER_VERSION_MAJOR 17
#define KVS_COMPILER_VERSION_MINOR 7
#define KVS_COMPILER_VERSION_PATCH 0

// Visual Studio 2022 Update 8
#elif ( _MSC_VER == 1938 )
#define KVS_COMPILER_VERSION_MAJOR 17
#define KVS_COMPILER_VERSION_MINOR 8
#define KVS_COMPILER_VERSION_PATCH 3

// Visual Studio 2022 Update 9
#elif ( _MSC_VER == 1939 )
...
// Visual Studio 2022 Update 10 (_MSC_FULL_VER == 194033811)
#else
#define KVS_COMPILER_VERSION_MAJOR 17
#define KVS_COMPILER_VERSION_MINOR 10
#define KVS_COMPILER_VERSION_PATCH 5
#endif

// Visual Studio 2022 Update 11
#elif ( _MSC_VER == 1941 )
#define KVS_COMPILER_VERSION_MAJOR 17
#define KVS_COMPILER_VERSION_MINOR 11
#define KVS_COMPILER_VERSION_PATCH 0

// Visual Studio 2022 Update 12
#elif ( _MSC_VER == 1942 )
#if ( _MSC_FULL_VER < 194234436 )
#define KVS_COMPILER_VERSION_MAJOR 17
#define KVS_COMPILER_VERSION_MINOR 12
#define KVS_COMPILER_VERSION_PATCH 3

// Visual Studio 2022 Update 12 (_MSC_FULL_VER == 194234436)
#else
#define KVS_COMPILER_VERSION_MAJOR 17
#define KVS_COMPILER_VERSION_MINOR 12
#define KVS_COMPILER_VERSION_PATCH 4
#endif

// Visual Studio 2022 Update 13
#elif ( _MSC_VER == 1943 )
#define KVS_COMPILER_VERSION_MAJOR 17
#define KVS_COMPILER_VERSION_MINOR 13
#define KVS_COMPILER_VERSION_PATCH 0
