...
int main()
{
    ...
    std::cout << "kvs::Vec4::Random(seed) = " << kvs::Vec4::Random( 1 ) << std::endl;
    std::cout << "kvs::Vec4::Random(min,max) = " << kvs::Vec4::Random( -1.0f, 1.0f ) << std::endl;
    std::cout << "kvs::Vec4::Random(min,max,seed) = " << kvs::Vec4::Random( -1.0f, 1.0f, 2 ) << std::endl;
