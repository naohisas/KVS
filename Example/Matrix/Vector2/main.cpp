...
int main()
{
    ...
    std::cout << "kvs::Vec2::Random(seed) = " << kvs::Vec2::Random( 1 ) << std::endl;
    std::cout << "kvs::Vec2::Random(min,max) = " << kvs::Vec2::Random( -1.0f, 1.0f ) << std::endl;
    std::cout << "kvs::Vec2::Random(min,max,seed) = " << kvs::Vec2::Random( -1.0f, 1.0f, 2 ) << std::endl;
